...
export default function ErrorPage({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={reset}
        className="min-h-[44px] rounded-md bg-primary px-4 py-2 text-primary-foreground transition-all duration-200 hover:-translate-y-[1px] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 active:translate-y-0"
      >
        Tentar novamente
      </button>
    </main>
