...
export default function ExpensesLoading(): React.JSX.Element {
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 h-5 w-20 motion-safe:animate-pulse rounded bg-muted" />
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="pb-3 pr-4 text-left">
                <div className="h-4 w-28 motion-safe:animate-pulse rounded bg-muted" />
              </th>
          ...
          <tbody>
            {Array.from({ length: 5 }).map((_, i) => (
              <tr key={i} className="border-b border-border">
                ...
                <td className="py-3">
                  <div className="h-4 w-12 motion-safe:animate-pulse rounded bg-muted" />
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="mt-8 flex justify-center gap-4">
        <div className="h-10 w-24 motion-safe:animate-pulse rounded bg-muted" />
        <div className="h-10 w-24 motion-safe:animate-pulse rounded bg-muted" />
      </div>
    </main>
  )
