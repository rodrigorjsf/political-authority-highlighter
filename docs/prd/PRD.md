...
| System                            | Type      | Protocol            | Auth Method      | Rate Limit         | Cadence | Official Docs                                                    | Downloaded Docs                                                          |
| --------------------------------- | --------- | ------------------- | ---------------- | ------------------ | ------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------ |
...
| Portal da Transparencia           | REST API  | HTTPS, JSON         | API key (header) | 90 req/min         | Daily   | <https://api.portaldatransparencia.gov.br/api-de-dados>          | [portal-transparencia-api.json](/docs/api/portal-transparencia-api.json) |
...
| Development | Local development and testing        | Seed data (subset of real data)           | Developer only   | Supabase CLI local (supabase start); Docker Compose optional         |
